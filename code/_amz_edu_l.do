...
global sub_amostra_demografia = "edu_l"
...
compress
save "$output_dir\_amz_edu_l_numero_ocupados_por_ocupacao_2digitos.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_edu_l_numero_ocupados_por_atividade_2digitos.dta", replace
