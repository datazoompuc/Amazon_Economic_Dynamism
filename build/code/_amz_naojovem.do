...
global sub_amostra_demografia = "naojovem"
...
compress
save "$output_dir\_amz_naojovem_numero_ocupados_por_ocupacao_2digitos.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_naojovem_numero_ocupados_por_atividade_2digitos.dta", replace
