...
global sub_amostra_area_geografica = "Rondonia"
...
compress
save "$output_dir\_amz_ro_numero_ocupados_por_ocupacao_2digitos.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_ro_numero_ocupados_por_atividade_2digitos.dta", replace
