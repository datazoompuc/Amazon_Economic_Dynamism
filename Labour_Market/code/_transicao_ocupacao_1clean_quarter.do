...
sort idind Ano Trimestre
by idind, sort: gen position_act = 1 if trim[_n] == (trim[_n-1] + 1)

* generate variable for previous position
sort idind Ano Trimestre
by idind, sort: gen position_pre = 1 if trim[_n] == (trim[_n+1] - 1)
...
by idind, sort: gen itenA = V1028 	/*
	...
	*/ 	& position_act[_n+1] ==1 	/*
	*/ 	& `yy'[_n] == 1 	/*
	*/ 	& `xx'[_n+1] == 1	 // individual who are tem_var_x
